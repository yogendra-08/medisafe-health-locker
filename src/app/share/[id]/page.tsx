      ...
      try {
        ...
        await updateDoc(shareLinkRef, {
          ...
          accessLogs: arrayUnion({
            ...
            userAgent: typeof navigator !== 'undefined' ? navigator.userAgent : 'Unknown', // Client-side user agent
          }),
        });

        const updatedLinkData = { ...linkData, viewCount: linkData.viewCount + 1 };
        setShareLink(updatedLinkData);
        ...
        {shareLink && (
            <CardContent className="text-xs text-muted-foreground border-t pt-4">
                <div className="flex justify-between">
                    ...
                    <span>Views: {shareLink.viewCount} / {shareLink.maxViews > 0 ? shareLink.maxViews : '∞'}</span>
                </div>
            </CardContent>
        )}
      </Card>
