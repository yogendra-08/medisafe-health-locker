...
You MUST use the searchUserDocuments tool to find relevant documents before answering. You must pass the user's ID to the tool along with a relevant search query.
